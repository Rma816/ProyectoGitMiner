...
public class IssueGHM {
    ...
    @JsonProperty("user")
    public UserGHM getUser() {
        return user;
    }

    @JsonProperty("user")
    public void setUser(UserGHM user) {
        this.user = user;
    }
    ...
    @JsonProperty("repository")
    public ProjectGHM getRepository() {
        return repository;
    }

    @JsonProperty("repository")
    public void setRepository(ProjectGHM repository) {
    ...
    public String toString() {
        ...
        sb.append(IssueGHM.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("id");
        sb.append('=');
