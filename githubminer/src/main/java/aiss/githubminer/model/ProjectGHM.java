...
import aiss.githubminer.model.projectD.ProjectLicense;
import aiss.githubminer.model.projectD.ProjectPermissions;
import com.fasterxml.jackson.annotation.JsonIgnoreProperties;
import com.fasterxml.jackson.annotation.JsonProperty;

@JsonIgnoreProperties(ignoreUnknown = true)
public class ProjectGHM {
    ...
    @JsonProperty("owner")
    public UserGHM getOwner() {
        return owner;
    }

    @JsonProperty("owner")
    public void setOwner(UserGHM owner) {
        this.owner = owner;
    }
    ...
    public String toString() {
        ...
        sb.append(ProjectGHM.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("id");
        sb.append('=');
