package aiss.githubminer.model.issueD;
...
public class IssueMilestone {
    ...
    @JsonProperty("creator")
    public UserGHM getCreator() {
        return creator;
    }

    @JsonProperty("creator")
    public void setCreator(UserGHM creator) {
    ...
    public String toString() {
        ...
        sb.append(IssueMilestone.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("url");
        sb.append('=');
